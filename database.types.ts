  ...
  public: {
    Tables: {
      business_locations: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["business_id"];
            isOneToOne: false;
            referencedRelation: "v_business_profiles";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      food_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "food_items_pickup_point_id_fkey";
      ...
      reservation_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "reservation_items_food_item_id_fkey";
      ...
      reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: "reservations_pickup_point_id_fkey";
            columns: ["pickup_point_id"];
            isOneToOne: false;
            referencedRelation: "pickup_points";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      job_status_enum:
        ...
        | "student"
        | "other";
      reservation_status_enum: "active" | "picked_up" | "canceled" | "expired";
    };
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null;
